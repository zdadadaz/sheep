...
class RandomWalk{
    ...
    public:
        ...
        void assign(int x, int y, int d){sx = x; sy=y; sd= d; threadId = y%numThread;};
};
RandomWalk::RandomWalk(int inx, int iny, int ind){sx = inx; sy=iny; sd = ind; threadId = iny%numThread;}
